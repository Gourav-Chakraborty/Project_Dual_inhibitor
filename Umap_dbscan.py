...
def tune_umap_silhouette(data, max_neighbors=2500, min_dist_start=0.1, min_dist_end=0.5, min_dist_stride=0.1):
    silhouette_scores = []
    param_combinations = []
    ...
    for min_dist in tqdm(min_dist_range, desc="UMAP Hyperparameters"):
        for n_neighbors in range(10, max_neighbors + 1, 50):
            ...
            umap_model = UMAP(n_components=2, n_neighbors=n_neighbors, min_dist=min_dist, n_jobs=32)
